...
sidebarTitle: "Orders"
description: "The MesobOrdering Waiter Orders page shows every active order with color-coded status badges and quick actions to move PENDING orders into PREPARING."
---

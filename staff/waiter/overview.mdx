...
description: "What Waiters can and cannot do in MesobOrdering, including permissions, login flow, default landing page, and table and order management access."
---

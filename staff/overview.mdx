...
description: "Introduction to the MesobOrdering Staff Guide covering Kitchen, Waiter, Cashier, and Bar roles with permissions, login flow, and status references."
---
